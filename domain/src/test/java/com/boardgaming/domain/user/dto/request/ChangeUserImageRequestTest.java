...
class ChangeUserImageRequestTest {
    ...
    void test1() {
        //given
        ChangeUserImageRequest request = new ChangeUserImageRequest();
        List<String> violationPropertyPaths = List.of("imageFileInfoId");

        //when
        Set<ConstraintViolation<ChangeUserImageRequest>> violations = validator.validate(request);
